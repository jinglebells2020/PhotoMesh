...
{
  "components": [
    {"id": "R1", "type": "resistor", "value": 100, "node_a": "n1", "node_b": "n2"},
    {"id": "V1", "type": "voltage_source", "value": 12, "positive_node": "n1", "negative_node": "0"},
    {"id": "I1", "type": "current_source", "value": 0.002, "from_node": "0", "to_node": "n2"}
  ],
  "ground_node": "0",
  "meshes": [["V1", "R1", "R2"]],
