...
struct MathPreviewView: View {
    ...
    private let samples: [Sample] = [
        Sample(group: "KCL", line: "through R1 to n1: (V₂ − V₁)/R1 = (V₂ − 9)/1000"),
        Sample(group: "KCL", line: "Sum of currents leaving n2 = 0:  (V₂ − 9)/1000 + V₂/2000 + V₂/2000 = 0"),
        Sample(group: "KCL", line: "× 2000:  2·(V₂ − 9) + V₂ + V₂ = 0"),
        Sample(group: "KCL", line: "→ 4·V₂ = 18"),
        Sample(group: "KCL", line: "I1 pushes 3 A into n2: −3"),
        ...
        Sample(group: "Solving", line: "17·V(b) − 2·5.935 = 100"),
        Sample(group: "Solving", line: "→ V₂ = 571.4 mV"),
        Sample(group: "Results", line: "I(R1) = (12 − 8.25)/100 = 37.5 mA  (from n1 to n2)"),
        Sample(group: "Results", line: "V(R1) = R1·I(R1) = 100 Ω·37.5 mA = 3.75 V"),
        Sample(group: "Results", line: "I(R2) = I₁ − I₂ = 1.923 A + (−384.6 mA) = 1.538 A"),
        Sample(group: "Results", line: "I(V1): KCL at n1 → I(R1) = 4.5 mA leaves through the other elements, so V1 delivers 4.5 mA"),
        ...
        Sample(group: "Check", line: "KCL at n2: in 4.5 mA = 4.5 mA, out 2.25 mA + 2.25 mA = 4.5 mA ✓"),
        Sample(group: "Simplify", line: "R2 ‖ R3: both between n2 and 0"),
        Sample(group: "Simplify", line: "R23 = (R2·R3)/(R2 + R3) = (2000·2000)/(2000 + 2000) = 1 kΩ"),
        Sample(group: "Simplify", line: "R1 — n2 — R23: nothing else connects at n2"),
        Sample(group: "Simplify", line: "Series: R = R₁ + R₂ (same current)"),
        Sample(group: "DC redraw", line: "L1 (inductor): short circuit → V(L1) = 0, node n3 is node n2"),
        Sample(group: "DC redraw", line: "C1 = 10 µF between n3 and 0"),
